package com.example.empresayego.View.OrderUI.ProcessOrder.Detail.Ayuda.IncrementPrice;
...
import com.example.empresayego.View.OrderUI.ProcessOrder.Restaurante_PedidoProcesResultsAdapter;
import com.example.empresayego.View.ProcesoOrdenActivity;

public class IncrementPriceActivity extends AppCompatActivity implements IncrementPriceFragment.OnDataPassPrice {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_increment_price);
        reciveDataIntent();
      ...
      /*  IncrementPriceFragment fragment1 = (IncrementPriceFragment) getSupportFragmentManager().findFragmentById(R.id.fragment_INCREMENT_PRICE_FRAGMENT);
        if(fragment1 !=null){
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_INCREMENT_PRICE_FRAGMENT,fragment).commit();
    }
    ...
    public static Intent newIntentIncrementPriceActivity(Context context, Restaurante_Pedido restaurante_pedido){
        Intent intent= new Intent(context, IncrementPriceActivity.class);
    ...
    @Override
    public void onDataPassIncrementPrice(boolean respuesta) {
