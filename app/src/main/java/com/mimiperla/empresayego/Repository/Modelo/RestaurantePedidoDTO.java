...
public class RestaurantePedidoDTO implements Serializable {
    ...
    @Expose
    private String ventafechaentrega;
    ...
    public String getVentafechaentrega() {
        return ventafechaentrega;
    }

    public void setVentafechaentrega(String ventafechaentrega) {
