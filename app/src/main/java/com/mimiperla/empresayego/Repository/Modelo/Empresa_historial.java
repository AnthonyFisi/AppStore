...
public class Empresa_historial  implements Serializable {
    ...
    @SerializedName("idestadoempresaofi")
    @Expose
    private int  idestadoempresaofi;
    ...
    public int getIdestadoempresaofi() {
        return idestadoempresaofi;
    }

    public void setIdestadoempresaofi(int idestadoempresaofi) {
        this.idestadoempresaofi = idestadoempresaofi;
    }
}
