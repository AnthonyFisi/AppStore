...
public class DialogUpdateCelularFragment extends AppCompatDialogFragment {
  ...
  //  private DialogUpdateCelular listener;
    ...
    public static DialogUpdateCelularFragment newInstance(Empresa empresa){
        DialogUpdateCelularFragment fragment= new DialogUpdateCelularFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        numeroCelular=mEmpresa.getCelular_empresa();
        ...
        viewModel.getEmpresaOficialLiveData().observe(this, new Observer<EmpresaOficial>() {
            ...
            public void onChanged(EmpresaOficial empresa) {
                ...
                if(empresa !=null){
                    ...
                    Empresa.sEmpresa.setCelular_empresa(empresa.getCelular_empresa());
                    textView_numero_celular.setText( Empresa.sEmpresa.getCelular_empresa());
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view=LayoutInflater.from(getContext()).inflate(R.layout.dialog_update_celular,null);
        ...
        cardView_update_celular.setOnClickListener(v->{
            ...
            if(dialog_update_CELULAR.getText().toString().length()==9 && String.valueOf(dialog_update_CELULAR.getText().charAt(0)).equals(String.valueOf(9))){

                viewModel.updateNumeroCelular(mEmpresa.getIdempresa(),dialog_update_CELULAR.getText().toString());
