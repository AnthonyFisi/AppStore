...
import com.mimiperla.empresayego.View.OrderUI.NewOrder.Detail.NewOrderDetailActivity;
            ...
            if (getActivity() != null) {
                ...
                getActivity().runOnUiThread(() -> {
                    try {
                        ...
                        Restaurante_Pedido object = ProcesoOrdenActivity.convertObject(restaurantePedidoDTO);
                        ...
                        adapter.addResults(object,ListNewOdersFragment.this);
